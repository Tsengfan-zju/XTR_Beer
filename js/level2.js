...
const scenarioData = {
    management: [
        ...
        { id: 2, title: '运营后台', description: '运营后台展示可更改的各项参数，点击即可编辑。<br><br><table class="parameter-table">\n<thead>\n  <tr>\n    <th>参数类型</th>\n    <th>参数名称</th>\n    <th>说明</th>\n  </tr>\n</thead>\n<tbody>\n  <tr>\n    <td rowspan="7" class="category">基本参数</td>\n    <td>名称</td>\n    <td>当前酒的名称（其他：点击其他，可选择已另存的酒类）</td>\n  </tr>\n  <tr>\n    <td>单价</td>\n    <td>单次出酒量对应的价格</td>\n  </tr>\n  <tr>\n    <td>限制时间</td>\n    <td>单次打酒的倒计时</td>\n  </tr>\n  <tr>\n    <td>单次出酒</td>\n    <td>单次打酒的毫升数</td>\n  </tr>\n  <tr>\n    <td>容器总量</td>\n    <td>酒桶的容量</td>\n  </tr>\n  <tr>\n    <td>报警阈值</td>\n    <td>当酒桶的容量为多少时，停止售卖</td>\n  </tr>\n  <tr>\n    <td>累计售卖</td>\n    <td>目前已售卖的酒量，不可编辑（清零：点击清零后，累计售卖清零。注意在每次更换酒桶后需要手动清零，否则将引起“售罄”现象）</td>\n  </tr>\n  <tr>\n    <td rowspan="3" class="category">脉冲系数校准</td>\n    <td>出酒量</td>\n    <td>校准的出酒量</td>\n  </tr>\n  <tr>\n    <td>脉冲数</td>\n    <td>校准的出酒量所对应的脉冲数</td>\n  </tr>\n  <tr>\n    <td>脉冲系数</td>\n    <td>脉冲数/出酒量的比值</td>\n  </tr>\n  <tr>\n    <td rowspan="2" class="category">操作说明</td>\n    <td>保存</td>\n    <td>每次修改后必须保存本次修改</td>\n  </tr>\n  <tr>\n    <td>另存为</td>\n    <td>将本套方案另存至配方，方便下次直接选择该方案</td>\n  </tr>\n</tbody>\n</table>', image: '../picture/level2/1-2.png' },
...
function updateStepContent() {
    ...
    stepDescription.innerHTML = currentStepData.description;
}
